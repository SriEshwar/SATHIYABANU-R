...
fs.readFile('calculate.js','utf8',function(err,data){ 
    console.log(data)
})
...
fs.writeFile('calculate1.js','console.log("Wecome Aspire")',function(err,data){
    if (err) throw err; 
...
fs.writeFile('calculate2.js','console.log("done")',function(err,data){ 
    console.log("creating and renaming the file")
            ...
            // Rename the file
fs.rename('calculate2.js', 'calcrenamedfile.js', function (err) {
    if (err) throw err;
